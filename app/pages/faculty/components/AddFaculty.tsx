...
function AddFaculty({ onAddFaculty, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await db.createDocument("650c46ce8f031e26fd6d","650c46e2e1a1bcd7c852",ID.unique(),formData);
      ...
      if (image) {
        ...
        const fileResponse = await storage.createFile('6506e1c443a66bc104ce', response.$id, storageFile);
